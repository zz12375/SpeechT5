...
class InferenceProcessor:
    ...
    def __init__(self, cfg: InferConfig) -> None:
        ...
        from speechut.modules.ctc_decoder import Decoder
    ...
    def process_sentence(
        ...
        if "words" in hypo:
            ...
            pieces = hypo["tokens"].int().cpu()
            pieces = pieces[pieces!=self.tgt_dict.unk()].unique_consecutive()
            hyp_words = self.tgt_dict.string(pieces)
        ...
        pieces = target_tokens.int().cpu()
        pieces = pieces[pieces!=self.tgt_dict.unk()].unique_consecutive()
        tgt_words = self.tgt_dict.string(pieces)
