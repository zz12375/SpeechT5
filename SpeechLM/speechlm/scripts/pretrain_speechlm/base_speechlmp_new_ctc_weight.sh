...
[ -z $text_ctc_weight ] && echo "text_ctc_weight not specified! exit" && exit 1

CODE_ROOT=${PWD}
MODEL_DIR="${mount}/exp/pretrain/base_speechlmp_ctc${text_ctc_weight}_${world_size}gpu_${update_freq}accum"
...
python $CODE_ROOT/fairseq/fairseq_cli/hydra_train.py \
  ...
  criterion.text_ctc_weight=$text_ctc_weight \
  \
...
# data_dir="/modelblob/users/v-ziqzhang/dataset/LibriLM/tri4b_decode"
# text_data_dir="/modelblob/users/v-ziqzhang/dataset/LibriLM/phn2char_sanych/filt2k_sil025_m5std25_sil14_spn32/bin-idx"
